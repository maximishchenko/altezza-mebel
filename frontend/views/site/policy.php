...
<div class="policy">
    <p>
        ...
        обеспечению безопасности персональных данных, предпринимаемые Степановым Владиславом Александровичем (далее – Оператор).
    </p>

    <div class="policy__item">
        <div class="policy__item__title">
            <h5>1. Общие положения</h5>
        </div>
        <div class="policy__item__list">
            <div class="policy__item__list__element">
    ...
    <div class="policy__item">
        ...
        <div class="policy__item__list">
            <div class="policy__item__list__element">
                ...
                помощью электронной почты <?= Html::mailto(Yii::$app->configManager->getItemValue('contactEmail'), Yii::$app->configManager->getItemValue('contactEmail')); ?>.
            </div>
            <div class="policy__item__list__element">
            ...
            <div class="policy__item__list__element">
                ...
                по адресу <?= Html::a(Url::toRoute('/policy', true), Url::toRoute('/policy', true), ['target' => '_blank']); ?>
            </div>
        </div>
    </div>
</div>