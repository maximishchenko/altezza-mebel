...
use backend\modules\content\models\search\CollaborationSearch;
...
class CollaborationController extends BaseController
{
    ...
    {
        $model = $this->findModel($id);
        $file = $model->getPath(Collaboration::UPLOAD_PATH, $model->image);
     ...
     * @throws NotFoundHttpException
     */
    protected function findModel(int $id): Collaboration
    {
        if (($model = Collaboration::findOne(['id' => $id])) !== null) {
            return $model;
        }
