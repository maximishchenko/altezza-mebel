...
/**
 * PropertyFurnitureSearch represents the model behind the search form of `backend\modules\catalog\models\PropertyFurniture`.
 */
class PropertyFurnitureSearch extends PropertyFurniture
{
    /**
     * {@inheritdoc}
     */
